...
/**
 * Servlet implementation class ClearUnread
 */
@WebServlet("/ClearUnread")
public class ClearUnread extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql = "update User set unreadcount = 0 where id = ?";
